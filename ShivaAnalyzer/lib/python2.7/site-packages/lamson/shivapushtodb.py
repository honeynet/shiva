    ...
    for record in server.QueueReceiver.records:
        ...
        if len(record['attachmentFile']) > 0:
            ...
            while i < len(record['attachmentFile']):
                ...
                insertAttachment = "INSERT INTO `attachments`(`spam_id`, `file_name`, `attach_type`, `attachmentFileMd5`, `date`) VALUES ('" + str(record['s_id']) + "', '" + str(mdb.escape_string(fileName)) + "', '" + 'Attachment' + "', '" + str(record['attachmentFileMd5'][i]) + "', '" + str(record['date']) + "')"
        ...
        if len(record['inlineFile']) > 0:
            ...
            while i < len(record['inlineFile']):
                ...
                insertInline = "INSERT INTO `attachments`(`smap_id`, `file_name`, `attach_type`, `attachmentFileMd5`, `date`) VALUES ('" + str(record['s_id']) + "', '" + str(mdb.escape_string(fileName)) + "', '" + 'Inline' + "', '" + str(record['inlineFileMd5'][i]) + "', '" + str(record['date']) + "')"
